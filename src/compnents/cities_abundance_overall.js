...
export default function CitiesAbundanceOverAll(props) {
    ...
    for (var city of groups) {
        for (var tree of subGroups) {
            ...
            if (tree in data_abundance[city]) {
                obj_to_append["value"] = data_abundance[city][tree][0]
            }
    ...
    const subGroups_colors = subGroups.map((subgroup, i) => {
        var y = boundsHeight / 2 + i * yScale.bandwidth()
        return (
            <g>
                <rect
                    key={i}
    ...
    return (
        ...
        <div className="row">
                <div className="col-md-12 text-center">
                    <h2>
                        Trees Abundances Across Different Cities 
                    </h2>
                    <h4>
                        Abundance of the Top 5 Trees in the United States Among the Top 10 Greenest Cities
                    </h4>
                </div>
            </div>
        <div className="row">
